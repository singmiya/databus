package com.ronfton.dbus.client.util;
...
public class ClassUtil {
    ...
    private static void putClass(String className, List<Class<?>> classes) {
        try {
